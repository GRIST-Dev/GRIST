...
#ifdef ResNet
   use module_cu_ResNet_hybrid_v2,   only: ResNet_hybrid_init, ResNet_hybrid_tend, ResNet_hybrid_final
...
#ifdef Cutime
   integer(i4)  :: clock_cu_cps, clock_cu_mps
#endif
...
!
...
#ifdef Cutime
      clock_cu_cps=clock_id('Cu_cps')
      call clock_begin(clock_cu_cps)
#endif
    ...
    case('ResNet_hybrid')
#ifdef Cutime
      clock_cu_mps=clock_id('Cu_mps')
      call clock_begin(clock_cu_mps)
#endif
...
! ad-hoc
       ...
       ptend_wrf%rqvcuten(1:ncell,1:2,1:1) = zero
       psurf_wrf%raincv                    = psurf_wrf%raincv*dtime
#endif
#ifdef Cutime
      call clock_end(clock_cu_mps)
#endif
    case default
