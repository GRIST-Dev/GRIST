...
#ifdef TEND_IO
        type(scalar_2d_field)  :: rthmpten
        type(scalar_2d_field)  :: rqvmpten ! as in wsm6 and first six of morr
!        type(scalar_2d_field)  :: qcmpten ! as in wsm6 and first six of morr
!        type(scalar_2d_field)  :: qrmpten ! as in wsm6 and first six of morr
!        type(scalar_2d_field)  :: qimpten ! as in wsm6 and first six of morr
!        type(scalar_2d_field)  :: qsmpten ! as in wsm6 and first six of morr
!        type(scalar_2d_field)  :: qgmpten
        type(scalar_2d_field)  :: rthraten
        type(scalar_2d_field)  :: rqvcuten
        type(scalar_2d_field)  :: rqvblten
        type(scalar_2d_field)  :: rthcuten
        type(scalar_2d_field)  :: rthblten
        type(scalar_2d_field)  :: u_phy
        type(scalar_2d_field)  :: v_phy
        type(scalar_2d_field)  :: omega_wrf
        type(scalar_2d_field)  :: t_phy
        type(scalar_2d_field)  :: moist
        type(scalar_2d_field)  :: p_phy
#endif
...
! surface-lsm
        ...
        integer(i4)            :: ncount
#ifdef TEND_IO_1d
        type(scalar_1d_field)  :: rainncv
        type(scalar_1d_field)  :: snowncv
        type(scalar_1d_field)  :: graupelncv
        type(scalar_1d_field)  :: xlat
        type(scalar_1d_field)  :: albedo
        type(scalar_1d_field)  :: coszr
        type(scalar_1d_field)  :: glw
        type(scalar_1d_field)  :: olr
        type(scalar_1d_field)  :: gsw
        type(scalar_1d_field)  :: psfc
        type(scalar_1d_field)  :: znt
        type(scalar_1d_field)  :: ust
        type(scalar_1d_field)  :: pblh
        type(scalar_1d_field)  :: psim
        type(scalar_1d_field)  :: psih
        type(scalar_1d_field)  :: xland
        type(scalar_1d_field)  :: wspd
        type(scalar_1d_field)  :: br
#endif
...
#ifdef TEND_IO_1d
       call wrap_allocate_data1d(mesh,     diag_phys_accu_vars_h1_1d%rainncv)
       call wrap_allocate_data1d(mesh,     diag_phys_accu_vars_h1_1d%snowncv)
       call wrap_allocate_data1d(mesh,     diag_phys_accu_vars_h1_1d%graupelncv)
       call wrap_allocate_data1d(mesh,     diag_phys_accu_vars_h1_1d%xlat)
       call wrap_allocate_data1d(mesh,     diag_phys_accu_vars_h1_1d%albedo)
       call wrap_allocate_data1d(mesh,     diag_phys_accu_vars_h1_1d%coszr)
       call wrap_allocate_data1d(mesh,     diag_phys_accu_vars_h1_1d%glw)
       call wrap_allocate_data1d(mesh,     diag_phys_accu_vars_h1_1d%olr)
       call wrap_allocate_data1d(mesh,     diag_phys_accu_vars_h1_1d%gsw)
       call wrap_allocate_data1d(mesh,     diag_phys_accu_vars_h1_1d%psfc)
       call wrap_allocate_data1d(mesh,     diag_phys_accu_vars_h1_1d%znt)
       call wrap_allocate_data1d(mesh,     diag_phys_accu_vars_h1_1d%ust)
       call wrap_allocate_data1d(mesh,     diag_phys_accu_vars_h1_1d%pblh)
       call wrap_allocate_data1d(mesh,     diag_phys_accu_vars_h1_1d%psim)
       call wrap_allocate_data1d(mesh,     diag_phys_accu_vars_h1_1d%psih)
       call wrap_allocate_data1d(mesh,     diag_phys_accu_vars_h1_1d%xland)
       call wrap_allocate_data1d(mesh,     diag_phys_accu_vars_h1_1d%wspd)
       call wrap_allocate_data1d(mesh,     diag_phys_accu_vars_h1_1d%br)
#endif
...
#endif
#ifdef TEND_IO
       call wrap_allocate_data2d(mesh,nlev ,diag_phys_accu_vars_h1_2d%rthraten)
       call wrap_allocate_data2d(mesh,nlev ,diag_phys_accu_vars_h1_2d%rthcuten)
       call wrap_allocate_data2d(mesh,nlev ,diag_phys_accu_vars_h1_2d%rthmpten)
       call wrap_allocate_data2d(mesh,nlev ,diag_phys_accu_vars_h1_2d%rqvmpten)
       call wrap_allocate_data2d(mesh,nlev ,diag_phys_accu_vars_h1_2d%rqvblten)
       call wrap_allocate_data2d(mesh,nlev ,diag_phys_accu_vars_h1_2d%rqvcuten)
       call wrap_allocate_data2d(mesh,nlev ,diag_phys_accu_vars_h1_2d%rthblten)
       call wrap_allocate_data2d(mesh,nlev ,diag_phys_accu_vars_h1_2d%rthmpten)
       call wrap_allocate_data2d(mesh,nlev ,diag_phys_accu_vars_h1_2d%u_phy)
       call wrap_allocate_data2d(mesh,nlev ,diag_phys_accu_vars_h1_2d%v_phy)
       call wrap_allocate_data2d(mesh,nlev ,diag_phys_accu_vars_h1_2d%omega_wrf)
       call wrap_allocate_data2d(mesh,nlev ,diag_phys_accu_vars_h1_2d%t_phy)
       call wrap_allocate_data2d(mesh,nlev ,diag_phys_accu_vars_h1_2d%moist)
       call wrap_allocate_data2d(mesh,nlev ,diag_phys_accu_vars_h1_2d%p_phy)
#endif
#ifdef AMIPW_PHYSICS
...
#endif
#ifdef TEND_IO_1d
    if(allocated(diag_phys_accu_vars_h1_1d%rainncv%f))       deallocate(diag_phys_accu_vars_h1_1d%rainncv%f)
    if(allocated(diag_phys_accu_vars_h1_1d%snowncv%f)) deallocate(diag_phys_accu_vars_h1_1d%snowncv%f)
    if(allocated(diag_phys_accu_vars_h1_1d%graupelncv%f)) deallocate(diag_phys_accu_vars_h1_1d%graupelncv%f)
    if(allocated(diag_phys_accu_vars_h1_1d%xlat%f)) deallocate(diag_phys_accu_vars_h1_1d%xlat%f)
    if(allocated(diag_phys_accu_vars_h1_1d%albedo%f)) deallocate(diag_phys_accu_vars_h1_1d%albedo%f)
    if(allocated(diag_phys_accu_vars_h1_1d%coszr%f)) deallocate(diag_phys_accu_vars_h1_1d%coszr%f)
    if(allocated(diag_phys_accu_vars_h1_1d%glw%f))  deallocate(diag_phys_accu_vars_h1_1d%glw%f)
    if(allocated(diag_phys_accu_vars_h1_1d%olr%f)) deallocate(diag_phys_accu_vars_h1_1d%olr%f)
    if(allocated(diag_phys_accu_vars_h1_1d%gsw%f)) deallocate(diag_phys_accu_vars_h1_1d%gsw%f)
    if(allocated(diag_phys_accu_vars_h1_1d%psfc%f)) deallocate(diag_phys_accu_vars_h1_1d%psfc%f)
    if(allocated(diag_phys_accu_vars_h1_1d%graupelncv%f)) deallocate(diag_phys_accu_vars_h1_1d%znt%f)
    if(allocated(diag_phys_accu_vars_h1_1d%xlat%f)) deallocate(diag_phys_accu_vars_h1_1d%ust%f)
    if(allocated(diag_phys_accu_vars_h1_1d%albedo%f)) deallocate(diag_phys_accu_vars_h1_1d%pblh%f)
    if(allocated(diag_phys_accu_vars_h1_1d%coszr%f)) deallocate(diag_phys_accu_vars_h1_1d%psim%f)
    if(allocated(diag_phys_accu_vars_h1_1d%glw%f))  deallocate(diag_phys_accu_vars_h1_1d%psih%f)
    if(allocated(diag_phys_accu_vars_h1_1d%olr%f)) deallocate(diag_phys_accu_vars_h1_1d%xland%f)
    if(allocated(diag_phys_accu_vars_h1_1d%gsw%f)) deallocate(diag_phys_accu_vars_h1_1d%wspd%f)
    if(allocated(diag_phys_accu_vars_h1_1d%psfc%f)) deallocate(diag_phys_accu_vars_h1_1d%br%f)
#endif
       return
...
#ifdef TEND_IO
    if(allocated(diag_phys_accu_vars_h1_2d%rthraten%f))        deallocate(diag_phys_accu_vars_h1_2d%rthraten%f)
    if(allocated(diag_phys_accu_vars_h1_2d%rthcuten%f))        deallocate(diag_phys_accu_vars_h1_2d%rthcuten%f)
    if(allocated(diag_phys_accu_vars_h1_2d%rthmpten%f))       deallocate(diag_phys_accu_vars_h1_2d%rthmpten%f)
    if(allocated(diag_phys_accu_vars_h1_2d%rthblten%f)) deallocate(diag_phys_accu_vars_h1_2d%rthblten%f)
    if(allocated(diag_phys_accu_vars_h1_2d%rqvcuten%f)) deallocate(diag_phys_accu_vars_h1_2d%rqvcuten%f)
    if(allocated(diag_phys_accu_vars_h1_2d%rqvmpten%f)) deallocate(diag_phys_accu_vars_h1_2d%rqvmpten%f)
    if(allocated(diag_phys_accu_vars_h1_2d%rqvblten%f)) deallocate(diag_phys_accu_vars_h1_2d%rqvblten%f)
    if(allocated(diag_phys_accu_vars_h1_2d%u_phy%f))        deallocate(diag_phys_accu_vars_h1_2d%u_phy%f)
    if(allocated(diag_phys_accu_vars_h1_2d%v_phy%f))       deallocate(diag_phys_accu_vars_h1_2d%v_phy%f)
    if(allocated(diag_phys_accu_vars_h1_2d%omega_wrf%f)) deallocate(diag_phys_accu_vars_h1_2d%omega_wrf%f)
    if(allocated(diag_phys_accu_vars_h1_2d%t_phy%f)) deallocate(diag_phys_accu_vars_h1_2d%t_phy%f)
    if(allocated(diag_phys_accu_vars_h1_2d%moist%f)) deallocate(diag_phys_accu_vars_h1_2d%moist%f)
    if(allocated(diag_phys_accu_vars_h1_2d%p_phy%f)) deallocate(diag_phys_accu_vars_h1_2d%p_phy%f)
#endif
#endif
...
#endif
#ifdef TEND_IO_1d
    diag_phys_accu_vars_h1_1d%rainncv%f(1:ncell)  = diag_phys_accu_vars_h1_1d%rainncv%f(1:ncell)  + psurf_wrf%rainncv(1:ncell,1)
    diag_phys_accu_vars_h1_1d%snowncv%f(1:ncell)  = diag_phys_accu_vars_h1_1d%snowncv%f(1:ncell)  + psurf_wrf%snowncv(1:ncell,1)
    diag_phys_accu_vars_h1_1d%graupelncv%f(1:ncell)  = diag_phys_accu_vars_h1_1d%graupelncv%f(1:ncell)  + psurf_wrf%graupelncv(1:ncell,1)
    diag_phys_accu_vars_h1_1d%xlat%f(1:ncell)  = diag_phys_accu_vars_h1_1d%xlat%f(1:ncell)  + pstate_wrf%xlat(1:ncell,1)
    diag_phys_accu_vars_h1_1d%albedo%f(1:ncell)  = diag_phys_accu_vars_h1_1d%albedo%f(1:ncell)  + psurf_wrf%albedo(1:ncell,1)
    diag_phys_accu_vars_h1_1d%coszr%f(1:ncell)  = diag_phys_accu_vars_h1_1d%coszr%f(1:ncell)  + pstate_wrf%coszr(1:ncell,1)
    diag_phys_accu_vars_h1_1d%glw%f(1:ncell)  = diag_phys_accu_vars_h1_1d%glw%f(1:ncell)  + psurf_wrf%glw(1:ncell,1)
    diag_phys_accu_vars_h1_1d%olr%f(1:ncell)  = diag_phys_accu_vars_h1_1d%olr%f(1:ncell)  + pstate_wrf%olr(1:ncell,1)
    diag_phys_accu_vars_h1_1d%gsw%f(1:ncell)  = diag_phys_accu_vars_h1_1d%gsw%f(1:ncell)  + psurf_wrf%gsw(1:ncell,1)
    diag_phys_accu_vars_h1_1d%psfc%f(1:ncell)  = diag_phys_accu_vars_h1_1d%psfc%f(1:ncell)  + psurf_wrf%psfc(1:ncell,1)
    diag_phys_accu_vars_h1_1d%znt%f(1:ncell)  = diag_phys_accu_vars_h1_1d%znt%f(1:ncell)  + psurf_wrf%znt(1:ncell,1)
    diag_phys_accu_vars_h1_1d%ust%f(1:ncell)  = diag_phys_accu_vars_h1_1d%ust%f(1:ncell)  + psurf_wrf%ust(1:ncell,1)
    diag_phys_accu_vars_h1_1d%pblh%f(1:ncell)  = diag_phys_accu_vars_h1_1d%pblh%f(1:ncell)  + psurf_wrf%pblh(1:ncell,1)
    diag_phys_accu_vars_h1_1d%psim%f(1:ncell)  = diag_phys_accu_vars_h1_1d%psim%f(1:ncell)  + psurf_wrf%psim(1:ncell,1)
    diag_phys_accu_vars_h1_1d%psih%f(1:ncell)  = diag_phys_accu_vars_h1_1d%psih%f(1:ncell)  + psurf_wrf%psih(1:ncell,1)
    diag_phys_accu_vars_h1_1d%xland%f(1:ncell)  = diag_phys_accu_vars_h1_1d%xland%f(1:ncell)  + psurf_wrf%xland(1:ncell,1)
    diag_phys_accu_vars_h1_1d%wspd%f(1:ncell)  = diag_phys_accu_vars_h1_1d%wspd%f(1:ncell)  + psurf_wrf%wspd(1:ncell,1)
    diag_phys_accu_vars_h1_1d%br%f(1:ncell)  = diag_phys_accu_vars_h1_1d%br%f(1:ncell)  + psurf_wrf%br(1:ncell,1)
#endif
...
#ifdef TEND_IO
          diag_phys_accu_vars_h1_2d%rthraten%f(ilev,icell)=diag_phys_accu_vars_h1_2d%rthraten%f(ilev,icell)+ptend_wrf%rthraten(icell,nlev+1-ilev,1)
          diag_phys_accu_vars_h1_2d%rthcuten%f(ilev,icell)=diag_phys_accu_vars_h1_2d%rthcuten%f(ilev,icell)+ptend_wrf%rthcuten(icell,nlev+1-ilev,1)
          diag_phys_accu_vars_h1_2d%rthmpten%f(ilev,icell)=diag_phys_accu_vars_h1_2d%rthmpten%f(ilev,icell)+ptend_wrf%rthmpten(icell,nlev+1-ilev,1)
          diag_phys_accu_vars_h1_2d%rthblten%f(ilev,icell)=diag_phys_accu_vars_h1_2d%rthblten%f(ilev,icell)+ptend_wrf%rthblten(icell,nlev+1-ilev,1)
          diag_phys_accu_vars_h1_2d%rqvcuten%f(ilev,icell)=diag_phys_accu_vars_h1_2d%rqvcuten%f(ilev,icell)+ptend_wrf%rqvcuten(icell,nlev+1-ilev,1)
          diag_phys_accu_vars_h1_2d%rqvmpten%f(ilev,icell)=diag_phys_accu_vars_h1_2d%rqvmpten%f(ilev,icell)+ptend_wrf%rqvmpten(icell,nlev+1-ilev,1)
          diag_phys_accu_vars_h1_2d%rqvblten%f(ilev,icell)=diag_phys_accu_vars_h1_2d%rqvblten%f(ilev,icell)+ptend_wrf%rqvblten(icell,nlev+1-ilev,1)
          diag_phys_accu_vars_h1_2d%u_phy%f(ilev,icell)=ptend_wrf%rqvdyten(icell,nlev+1-ilev,1)*86400/1004*2500000
          diag_phys_accu_vars_h1_2d%v_phy%f(ilev,icell)=ptend_wrf%rthdyten(icell,nlev+1-ilev,1)*86400
          diag_phys_accu_vars_h1_2d%omega_wrf%f(ilev,icell)=pstate_wrf%omega(icell,nlev+1-ilev,1)
          diag_phys_accu_vars_h1_2d%t_phy%f(ilev,icell)=pstate_wrf%t_phy(icell,nlev+1-ilev,1)
          diag_phys_accu_vars_h1_2d%moist%f(ilev,icell)=pstate_wrf%moist(icell,nlev+1-ilev,1,1)
          diag_phys_accu_vars_h1_2d%p_phy%f(ilev,icell)=pstate_wrf%p_phy(icell,nlev+1-ilev,1)
!          diag_phys_accu_vars_h1_2d%rqcblten%f(ilev,icell)=diag_phys_accu_vars_h1_2d%rqcblten%f(ilev,icell)+ptend_wrf%rqcblten(icell,nlev+1-ilev,1)
!          diag_phys_accu_vars_h1_2d%rqiblten%f(ilev,icell)=diag_phys_accu_vars_h1_2d%rqiblten%f(ilev,icell)+ptend_wrf%rqiblten(icell,nlev+1-ilev,1)
#endif
       end do
    end do
! hard-coded here
...
#endif
#ifdef TEND_IO_1d
    diag_phys_accu_vars_h1_1d%rainncv%f = diag_phys_accu_vars_h1_1d%rainncv%f /diag_phys_accu_vars_h1_1d%ncount
    diag_phys_accu_vars_h1_1d%snowncv%f = diag_phys_accu_vars_h1_1d%snowncv%f /diag_phys_accu_vars_h1_1d%ncount
    diag_phys_accu_vars_h1_1d%graupelncv%f = diag_phys_accu_vars_h1_1d%graupelncv%f /diag_phys_accu_vars_h1_1d%ncount
    diag_phys_accu_vars_h1_1d%xlat%f = diag_phys_accu_vars_h1_1d%xlat%f /diag_phys_accu_vars_h1_1d%ncount
    diag_phys_accu_vars_h1_1d%albedo%f = diag_phys_accu_vars_h1_1d%albedo%f /diag_phys_accu_vars_h1_1d%ncount
    diag_phys_accu_vars_h1_1d%coszr%f = diag_phys_accu_vars_h1_1d%coszr%f /diag_phys_accu_vars_h1_1d%ncount
    diag_phys_accu_vars_h1_1d%glw%f = diag_phys_accu_vars_h1_1d%glw%f /diag_phys_accu_vars_h1_1d%ncount
    diag_phys_accu_vars_h1_1d%olr%f = diag_phys_accu_vars_h1_1d%olr%f /diag_phys_accu_vars_h1_1d%ncount
    diag_phys_accu_vars_h1_1d%gsw%f = diag_phys_accu_vars_h1_1d%gsw%f /diag_phys_accu_vars_h1_1d%ncount
    diag_phys_accu_vars_h1_1d%psfc%f = diag_phys_accu_vars_h1_1d%psfc%f /diag_phys_accu_vars_h1_1d%ncount
    diag_phys_accu_vars_h1_1d%znt%f = diag_phys_accu_vars_h1_1d%znt%f /diag_phys_accu_vars_h1_1d%ncount
    diag_phys_accu_vars_h1_1d%ust%f = diag_phys_accu_vars_h1_1d%ust%f /diag_phys_accu_vars_h1_1d%ncount
    diag_phys_accu_vars_h1_1d%pblh%f = diag_phys_accu_vars_h1_1d%pblh%f /diag_phys_accu_vars_h1_1d%ncount
    diag_phys_accu_vars_h1_1d%psim%f = diag_phys_accu_vars_h1_1d%psim%f /diag_phys_accu_vars_h1_1d%ncount
    diag_phys_accu_vars_h1_1d%psih%f = diag_phys_accu_vars_h1_1d%psih%f /diag_phys_accu_vars_h1_1d%ncount
    diag_phys_accu_vars_h1_1d%xland%f = diag_phys_accu_vars_h1_1d%xland%f /diag_phys_accu_vars_h1_1d%ncount
    diag_phys_accu_vars_h1_1d%wspd%f = diag_phys_accu_vars_h1_1d%wspd%f /diag_phys_accu_vars_h1_1d%ncount
    diag_phys_accu_vars_h1_1d%br%f = diag_phys_accu_vars_h1_1d%br%f /diag_phys_accu_vars_h1_1d%ncount
#endif
...
#ifdef TEND_IO
    diag_phys_accu_vars_h1_2d%rthraten%f=diag_phys_accu_vars_h1_2d%rthraten%f/diag_phys_accu_vars_h1_2d%ncount
    diag_phys_accu_vars_h1_2d%rthcuten%f=diag_phys_accu_vars_h1_2d%rthcuten%f/diag_phys_accu_vars_h1_2d%ncount
    diag_phys_accu_vars_h1_2d%rthmpten%f=diag_phys_accu_vars_h1_2d%rthmpten%f/diag_phys_accu_vars_h1_2d%ncount
    diag_phys_accu_vars_h1_2d%rthblten%f=diag_phys_accu_vars_h1_2d%rthblten%f/diag_phys_accu_vars_h1_2d%ncount
    diag_phys_accu_vars_h1_2d%rqvcuten%f=diag_phys_accu_vars_h1_2d%rqvcuten%f/diag_phys_accu_vars_h1_2d%ncount
    diag_phys_accu_vars_h1_2d%rqvmpten%f=diag_phys_accu_vars_h1_2d%rqvmpten%f/diag_phys_accu_vars_h1_2d%ncount
    diag_phys_accu_vars_h1_2d%rqvblten%f=diag_phys_accu_vars_h1_2d%rqvblten%f/diag_phys_accu_vars_h1_2d%ncount
#endif
#endif
...
#endif
#ifdef TEND_IO_1d
    diag_phys_accu_vars_h1_1d%rainncv%f  = zero
    diag_phys_accu_vars_h1_1d%snowncv%f  = zero
    diag_phys_accu_vars_h1_1d%graupelncv%f  = zero
    diag_phys_accu_vars_h1_1d%xlat%f  = zero
    diag_phys_accu_vars_h1_1d%albedo%f  = zero
    diag_phys_accu_vars_h1_1d%coszr%f  = zero
    diag_phys_accu_vars_h1_1d%glw%f  = zero
    diag_phys_accu_vars_h1_1d%olr%f  = zero
    diag_phys_accu_vars_h1_1d%gsw%f  = zero
    diag_phys_accu_vars_h1_1d%psfc%f  = zero
    diag_phys_accu_vars_h1_1d%znt%f  = zero
    diag_phys_accu_vars_h1_1d%ust%f  = zero
    diag_phys_accu_vars_h1_1d%pblh%f  = zero
    diag_phys_accu_vars_h1_1d%psim%f  = zero
    diag_phys_accu_vars_h1_1d%psih%f  = zero
    diag_phys_accu_vars_h1_1d%xland%f  = zero
    diag_phys_accu_vars_h1_1d%wspd%f  = zero
    diag_phys_accu_vars_h1_1d%br%f  = zero
#endif
...
#ifdef TEND_IO
    diag_phys_accu_vars_h1_2d%rthraten%f     = zero
    diag_phys_accu_vars_h1_2d%rthcuten%f     = zero
    diag_phys_accu_vars_h1_2d%rthmpten%f   = zero
    diag_phys_accu_vars_h1_2d%rthblten%f      = zero
    diag_phys_accu_vars_h1_2d%rqvcuten%f  = zero
    diag_phys_accu_vars_h1_2d%rqvmpten%f = zero
    diag_phys_accu_vars_h1_2d%rqvblten%f     = zero
    diag_phys_accu_vars_h1_2d%u_phy%f     = zero
    diag_phys_accu_vars_h1_2d%v_phy%f   = zero
    diag_phys_accu_vars_h1_2d%omega_wrf%f      = zero
    diag_phys_accu_vars_h1_2d%t_phy%f  = zero
    diag_phys_accu_vars_h1_2d%moist%f = zero
    diag_phys_accu_vars_h1_2d%p_phy%f     = zero
#endif
#endif
