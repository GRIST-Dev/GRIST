...
#ifdef TEND_IO
    call wrap_add_field_2d(diag_physics_vars_2d_h0%rthcuten           ,"rthcuten","rth tendency due to CU",""   )
    call wrap_add_field_2d(diag_physics_vars_2d_h0%rqvcuten    ,"rqvcuten" ,"qv tendency due to CU","")
#endif
