...
! 2d
        ...
        type(scalar_2d_field)  :: rqvcuten ! as in wsm6 and first six of morr
#endif
...
#ifdef TEND_IO
       call wrap_allocate_data2d(mesh,nlev ,diag_physics_vars_2d_h0%rthcuten)
       call wrap_allocate_data2d(mesh,nlev ,diag_physics_vars_2d_h0%rqvcuten)
#endif
...
#ifdef TEND_IO
    if(allocated(diag_physics_vars_2d_h0%rthcuten%f))        deallocate(diag_physics_vars_2d_h0%rthcuten%f)
    if(allocated(diag_physics_vars_2d_h0%rqvcuten%f)) deallocate(diag_physics_vars_2d_h0%rqvcuten%f)
#endif
...
#ifdef TEND_IO
          diag_physics_vars_2d_h0%rthcuten%f(ilev,icell)=diag_physics_vars_2d_h0%rthcuten%f(ilev,icell)+ptend_wrf%rthcuten(icell,nlev+1-ilev,1)
          diag_physics_vars_2d_h0%rqvcuten%f(ilev,icell)=diag_physics_vars_2d_h0%rqvcuten%f(ilev,icell)+ptend_wrf%rqvcuten(icell,nlev+1-ilev,1)
#endif
       end do
    end do
! hard-coded here
...
#ifdef TEND_IO
    diag_physics_vars_2d_h0%rthcuten%f=diag_physics_vars_2d_h0%rthcuten%f/diag_physics_vars_2d_h0%ncount
    diag_physics_vars_2d_h0%rqvcuten%f=diag_physics_vars_2d_h0%rqvcuten%f/diag_physics_vars_2d_h0%ncount
#endif
#endif
    end if
...
#ifdef TEND_IO
    diag_physics_vars_2d_h0%rthcuten%f     = zero
    diag_physics_vars_2d_h0%rqvcuten%f  = zero
#endif
#endif
