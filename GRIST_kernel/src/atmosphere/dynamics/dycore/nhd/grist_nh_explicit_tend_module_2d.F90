     ...
     case(3)
      do iv = 1, ncell_do
         do ilev = 2, nlev-1
            ...
            scalar_at_pc_full_level(ilev,iv)= part1-(der_k+der_kp1)/12._r8+sign(1._r8,scalar_eta_mass_velocity_at_pc_full(ilev,iv))*(der_kp1-der_k)/12._r8
         end do
      end do
     case default
...
!                                                     (deta_full(ilev+1)+deta_full(ilev))
!             scalar1_at_pc_full_level(ilev,iv)= part1-(der_k+der_kp1)/12._r8+sign(1._r8,scalar_eta_mass_velocity_at_pc_full(ilev,iv))*(der_kp1-der_k)/12._r8
...
!             scalar2_at_pc_full_level(ilev,iv)= part1-(der_k+der_kp1)/12._r8+sign(1._r8,scalar_eta_mass_velocity_at_pc_full(ilev,iv))*(der_kp1-der_k)/12._r8

            ! var1
            part1 = half*(scalar1_at_pc_face_level(ilev,iv)+scalar1_at_pc_face_level(ilev+1,iv))

            der_k = (deta_face(ilev)**2)*((scalar1_at_pc_face_level(ilev+1,iv)-scalar1_at_pc_face_level(ilev,iv))  /deta_full(ilev)-&
                                                (scalar1_at_pc_face_level(ilev,iv)  -scalar1_at_pc_face_level(ilev-1,iv))/deta_full(ilev-1))/&
                                                (deta_full(ilev)+deta_full(ilev-1))
            der_kp1 = (deta_face(ilev+1)**2)*((scalar1_at_pc_face_level(ilev+2,iv)-scalar1_at_pc_face_level(ilev+1,iv))/deta_full(ilev+1)-&
                                                    (scalar1_at_pc_face_level(ilev+1,iv)-scalar1_at_pc_face_level(ilev,iv))  /deta_full(ilev))/&
                                                    (deta_full(ilev+1)+deta_full(ilev))
            scalar1_at_pc_full_level(ilev,iv)= part1-(der_k+der_kp1)/6._r8+sign(1._r8,scalar_eta_mass_velocity_at_pc_full(ilev,iv))*(der_kp1-der_k)/6._r8
         
            ! var2
            part1 = half*(scalar2_at_pc_face_level(ilev,iv)+scalar2_at_pc_face_level(ilev+1,iv))
            der_k = (deta_face(ilev)**2)*((scalar2_at_pc_face_level(ilev+1,iv)-scalar2_at_pc_face_level(ilev,iv))  /deta_full(ilev)-&
                                                (scalar2_at_pc_face_level(ilev,iv)  -scalar2_at_pc_face_level(ilev-1,iv))/deta_full(ilev-1))/&
                                                (deta_full(ilev)+deta_full(ilev-1))
            der_kp1 = (deta_face(ilev+1)**2)*((scalar2_at_pc_face_level(ilev+2,iv)-scalar2_at_pc_face_level(ilev+1,iv))/deta_full(ilev+1)-&
                                                    (scalar2_at_pc_face_level(ilev+1,iv)-scalar2_at_pc_face_level(ilev,iv))  /deta_full(ilev))/&
                                                    (deta_full(ilev+1)+deta_full(ilev))

            scalar2_at_pc_full_level(ilev,iv)= part1-(der_k+der_kp1)/6._r8+sign(1._r8,scalar_eta_mass_velocity_at_pc_full(ilev,iv))*(der_kp1-der_k)/6._r8
